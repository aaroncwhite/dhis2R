---
title: "DHIS2R Intro Functions"
output: html_notebook
---
An overview of how to use these functions.
...
The functions are named intuitively enough.  You can GET objects, POST new objecs, PUT updated objects, or DELETE objects. 
